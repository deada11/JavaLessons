package src.StepikJavaBaseCourse2.classInheritance34.quiz;
...
public final class ComplexNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("hash cn1 & cn2 true // " + (cn1.hashCode() == cn2.hashCode()) + " " + cn1 + " " + cn2);
        System.out.println("hash cn2 & cn1 true // " + (cn2.hashCode() == cn1.hashCode()) + " " + cn2 + " " + cn1);
        System.out.println("hash cn3 & cn1 false // " + (cn3.hashCode() == cn1.hashCode()) + " " + cn3 + " " + cn1);
        System.out.println("hash cn3 & cn2 false // " + (cn3.hashCode() == cn2.hashCode()) + " " + cn3 + " " + cn2);
    }
}
